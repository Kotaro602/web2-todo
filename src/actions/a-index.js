...
export function reqTasks(firstFlg){return {type: REQ_TASKS, firstFlg}};
export function reqRedmineAll(oriTasks, firstFlg){return {type: REQ_REDMINE_ALL, oriTasks, firstFlg}};
export function reqRedmineIssueList(mergeObj, firstFlg){return {type: REQ_REDMINE_ISSUE_LIST, mergeObj, firstFlg}};
